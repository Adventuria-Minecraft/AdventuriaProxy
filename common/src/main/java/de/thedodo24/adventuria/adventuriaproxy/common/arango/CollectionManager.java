...
public class CollectionManager<Writable extends ArangoWritable<KeyType>, KeyType> {
    ...
    public CollectionManager(String collection, ArangoDatabase database, WritableGenerator<Writable, KeyType> generator, CacheCondition<Writable, KeyType> cacheCondition) {
    ...
    public CollectionManager(String collection, WritableGenerator<Writable, KeyType> generator, ArangoDatabase database, CacheCondition<Writable, KeyType> cacheCondition) {
    ...
    public boolean isCacheEnabled() { return this.cache != null; }

    public Writable getOrGenerate(KeyType key) { return this.getOrGenerate(key, this.generator); }
